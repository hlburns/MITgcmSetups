...
C
c         recip_hFacI(I,J,K,bi,bj) = .5D0*hFacC(I,J,Km1,bi,bj)
c     &        + MIN(.5D0,hFacC(I,J,K,bi,bj))
c         IF ( recip_hFacI(I,J,K,bi,bj) .NE. 0.D0 )
c     &        recip_hFacI(I,J,K,bi,bj)=1.D0/recip_hFacI(I,J,K,bi,bj)
          ENDDO
         ENDDO
        ENDDO
