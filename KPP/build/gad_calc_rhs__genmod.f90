        !COMPILER-GENERATED INTERFACE MODULE: Tue Jan 10 17:24:04 2017
     ...
     &MYTIME,MYITER,MYTHID)
              ...
              REAL(KIND=8) :: TRACERN(-3:29,-3:29,30,1,1)
              REAL(KIND=8) :: TRACAB(-3:29,-3:29,30,1,1)
