        !COMPILER-GENERATED INTERFACE MODULE: Tue Jan 10 17:27:41 2017
        MODULE MON_CALC_STATS_RL__genmod
          INTERFACE 
            SUBROUTINE MON_CALC_STATS_RL(MYNR,ARR,ARRHFAC,ARRMASK,      &
     &ARRAREA,ARRDR,THEMIN,THEMAX,THEMEAN,THESD,THEDEL2,THEVOL,MYTHID)
            ...
            END SUBROUTINE MON_CALC_STATS_RL
          END INTERFACE 
        END MODULE MON_CALC_STATS_RL__genmod
