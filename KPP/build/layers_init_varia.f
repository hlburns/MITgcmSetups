...
C     Keep track of time
      Real*8 layers_TimeAve(nSx,nSy)
      COMMON /LAYERS_TAVE/ layers_TimeAve


      Real*8 layers_VH_T(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nlayers,
     &                   nSx,nSy)
      Real*8 layers_Hs_T(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nlayers,
     &                   nSx,nSy)
        ...
        DO kg=1,Nlayers
         DO j=1-OLy,sNy+OLy
          DO i=1-OLx,sNx+OLx
           ...
           layers_VH (i,j,kg,bi,bj) = 0.D0
           layers_Hs (i,j,kg,bi,bj) = 0.D0
           layers_PIs(i,j,kg,bi,bj) = 0.D0
           layers_V  (i,j,kg,bi,bj) = 0.D0
