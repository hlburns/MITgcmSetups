        ...
        MODULE EXCH1_Z_R8_CUBE__genmod
          INTERFACE 
            SUBROUTINE EXCH1_Z_R8_CUBE(ARRAY,WITHSIGNS,MYOLW,MYOLE,MYOLS&
     ...
     &MYNZ,1,1)
            ...
            END SUBROUTINE EXCH1_Z_R8_CUBE
          END INTERFACE 
        END MODULE EXCH1_Z_R8_CUBE__genmod
