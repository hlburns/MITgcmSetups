        ...
        MODULE EXCH1_BG_RS_CUBE_AD__genmod
          INTERFACE 
            SUBROUTINE EXCH1_BG_RS_CUBE_AD(UFIELD,VFIELD,WITHSIGNS,MYOLW&
     ...
     &MYNZ,1,1)
            ...
            END SUBROUTINE EXCH1_BG_RS_CUBE_AD
          END INTERFACE 
        END MODULE EXCH1_BG_RS_CUBE_AD__genmod
