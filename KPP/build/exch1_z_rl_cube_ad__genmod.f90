        ...
        MODULE EXCH1_Z_RL_CUBE_AD__genmod
          INTERFACE 
            SUBROUTINE EXCH1_Z_RL_CUBE_AD(ARRAY,WITHSIGNS,MYOLW,MYOLE,  &
     ...
     &MYNZ,1,1)
            ...
            END SUBROUTINE EXCH1_Z_RL_CUBE_AD
          END INTERFACE 
        END MODULE EXCH1_Z_RL_CUBE_AD__genmod
