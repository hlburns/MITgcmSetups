C $Header: /u/gcmpack/MITgcm/pkg/flt/flt_mapping.F,v 1.4 2010/12/22 21:21:24 jahn Exp $
C $Name:  $
...
C     == end of interface ==
     ...
     &   ) THEN
        ...
        i = NINT(ix)
        j = NINT(jy)
        ddx = 0.5D0 + ix - DFLOAT(i)
        ddy = 0.5D0 + jy - DFLOAT(j)
